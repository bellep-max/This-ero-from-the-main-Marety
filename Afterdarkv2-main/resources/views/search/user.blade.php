                ...
                <div class="content">
                    ...
                    @if(count($result->artists))
                        <div id="albums-snapshot">
                            <div class="sub-header">
                                <h3 data-translate-text="TOP_ARTIST_MATCHES">Artist Matches</h3> <a class="view-more search-link" data-translate-text="SEE_ALL" data-searchquery="c" data-searchtype="album">{{ __('web.SEE_ALL') }}</a>
                            </div>
                            <ul class="snapshot">
                    ...
                    @if(count($result->albums))
                        ...
                        <div id="albums-snapshot">
                            <div class="sub-header">
                                <h3 data-translate-text="TOP_ALBUM_MATCHES">Album Matches</h3> <a class="view-more search-link" data-translate-text="SEE_ALL" data-searchquery="c" data-searchtype="album">{{ __('web.SEE_ALL') }}</a>
                            </div>
                            <ul class="snapshot">
                    ...
                    @if(count($result->playlists))
                        <div id="playlists-snapshot">
                            <div class="sub-header">
                                <h3 data-translate-text="TOP_PLAYLIST_MATCHES">Playlist Matches</h3> <a class="view-more search-link" data-translate-text="SEE_ALL" data-searchquery="c" data-searchtype="playlist">{{ __('web.SEE_ALL') }}</a>
                            </div>
                            <ul class="snapshot">
