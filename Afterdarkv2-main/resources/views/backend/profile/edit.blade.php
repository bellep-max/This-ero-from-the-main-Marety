    ...
    <div class="row">
        <div class="col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form role="form" action="{{ route('backend.profile.store') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control editor" rows="2" name="bio">{{ old('bio', $user->bio) }}</textarea>
                            </div>
                        </div>
        ...
        <div class="col-lg-5 main-section text-center">
            ...
            <div class="row user-detail">
                <div class="col-lg-12 col-sm-12 col-12">
                    <img src="{{ $user->artwork }}" class="rounded-circle img-thumbnail">
                    <h5>{{ $user->name }}</h5>
                    <p>{{ $user->email }}</p>
                    <table class="mt-4 table table-striped">
                        ...
                        <tr>
                            <td>Group</td>
                            <td>{{ \App\Models\Group::getValue('group_name') }}</td>
                        </tr>
                        <tr>
                            <td>Badge</td>
