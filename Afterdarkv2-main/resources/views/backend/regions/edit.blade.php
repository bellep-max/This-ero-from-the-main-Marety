...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <form method="POST" action="{{ route('backend.regions.update', $region) }}" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Name</label>
                    <div class="col-sm-9">
                        <input class="form-control" type="text" name="name" value="{{ old('name', $region->name) }}" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Alternative name (for SEO URL)</label>
                    <div class="col-sm-9">
                        <input class="form-control" type="text" name="alt_name" value="{{ old('alt_name', $region->alt_name) }}" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <label class="switch">
                            {!! BackendService::makeCheckbox('is_visible', old('is_visible', $region->is_visible ?? 0)) !!}
