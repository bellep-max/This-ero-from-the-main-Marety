...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="{{ route('backend.metatags.index') }}">Metatags</a></li>
        ...
        <div class="col-lg-12">
            <form method="post" action="" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input class="form-control" name="page_title" value="{{ $metatag->page_title }}" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <textarea class="form-control" rows="2" name="page_description">{{ $metatag->page_description }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Keywords</label>
                    <div class="col-sm-8">
                        {!! makeTagSelector('page_keywords[]', old('page_keywords', $metatag->page_keywords)) !!}
                    </div>
                </div>
