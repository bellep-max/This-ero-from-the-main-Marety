...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('backend.email.index') }}">Email templates</a></li>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form role="form" method="POST" action="{{ route('backend.email.update', $email) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
