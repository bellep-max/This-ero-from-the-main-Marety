...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <a href="{{ route('backend.coupons.create') }}" class="btn btn-primary">Add new coupon</a>
            <table class="mt-4 table table-striped">
                ...
                @foreach ($coupons as $index => $coupon)
                    <tr>
                        <td><a href="{{ route('backend.coupons.edit', ['coupon' => $coupon]) }}">{{ $coupon->code }}</a></td>
                        ...
                        <td>
                            <a href="{{ route('backend.coupons.edit', ['coupon' => $coupon]) }}" class="row-button edit"><i class="fas fa-fw fa-edit"></i></a>
                            <a href="{{ route('backend.coupons.destroy', ['coupon' => $coupon]) }}" class="row-button delete" onclick="return confirm('Are you sure to delete this page page?')"><i class="fas fa-fw fa-trash"></i></a>
                        </td>
                    </tr>
                @endforeach
            </table>
