...
@section('content')
    ...
    <form method="POST" action="{{ route('backend.posts.update', $post) }}" class="article-form form-horizontal" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
        <div class="row">
                        ...
                        <div class="tab-content mt-2" id="myTabContent">
                            <div id="news" class="tab-pane fade show active">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="datetime-local" name="published_at" value="{{ old('published_at', $post->published_at) }}" autocomplete="off">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control select2-active" multiple="" name="category[]">
                                            {!! \App\Services\Backend\BackendService::categorySelection(old('category', explode(',', $post->category))) !!}
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Short Content</label>
                                    <textarea data-filemanager-plugin-path="{{ asset('backend/js/filePlugin.js') }}" data-responsive-filemanager-plugin-path="{{ asset('backend/js/tinyPlugin.js') }}" data-external-filemanager-path="{{ route('backend.posts.media.associated', $post->id) }}" name="short_content" class="form-control post editor" rows="5">{{ old('short_content', $post->short_content) }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>Full Content</label>
                                    <textarea data-filemanager-plugin-path="{{ asset('backend/js/filePlugin.js') }}" data-responsive-filemanager-plugin-path="{{ asset('backend/js/tinyPlugin.js') }}" data-external-filemanager-path="{{ route('backend.posts.media.associated', $post->id) }}" name="full_content" class="form-control post editor" rows="20">{{ old('full_content', $post->full_content) }}</textarea>
                                </div>
                            </div>
                            <div id="advanced" class="tab-pane fade">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" name="alt_name" value="{{ old('alt_name', $post->alt_name) }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Tags</label>
                                    <div class="col-sm-9">
                                        {!! \App\Services\Backend\BackendService::makeTagSelector('tags[]', old('tags', $post->tags)) !!}
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-inline">
                                            <div class="input-group mr-3">
                                                ...
                                                <input type="datetime-local" class="form-control datetimepicker-with-form" name="log_expires" autocomplete="off" value="{{ old('log_expires', $post->log_expires) }}">
                                            </div>
                                            <select name="log_action" class="form-control select2-active">
                                                ...
                                                @foreach(\App\Constants\LogActionConstants::getList() as $value => $name)
                                                    <option value="{{ $value }}" @if(old('log_action', $post->log_action) == $value) selected @endif>{{ $name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" name="meta_title" value="{{ old('meta_title', $post->meta_title) }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Description meta tag</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" name="meta_description" value="{{ old('meta_description', $post->meta_description) }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Keywords meta tag</label>
                                    <div class="col-sm-9">
                                        {!! \App\Services\Backend\BackendService::makeTagSelector('meta_keywords[]', old('meta_keywords', $post->meta_keywords)) !!}
                                    </div>
                                </div>
                            </div>
                            <div id="voting" class="tab-pane fade">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" name="poll_title" value="{{ old('poll_title', $poll ? $poll->title : '') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Voting answer<br><span class="text-muted small">Each new line is a new answer option.</span></label>
                                    <div class="col-sm-9">
                                        <textarea name="poll_answers" class="form-control" rows="5">{{ old('poll_answers', $poll ? $poll->body : '') }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 col-8">
                                        <label class="switch">
                                            {!! \App\Services\Backend\BackendService::makeCheckbox('poll_multiple', old('poll_multiple', $poll ? $poll->multiple : '')) !!}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="datetime-local" name="poll_ended_at" value="{{ old('poll_ended_at', $poll ? $poll->ended_at : '') }}" autocomplete="off">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 col-8">
                                        <label class="switch">
                                            {!! \App\Services\Backend\BackendService::makeCheckbox('poll_visibility', old('poll_visibility', $poll ? $poll->is_visible : '')) !!}
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="featured-image">
                            <div id="featured-image" class="post-set-featured-image">
                                <span class="set @if($post->getFirstMediaUrl('artwork')) d-none @endif">Set featured image</span>
                                @if($post->getFirstMediaUrl('artwork'))
                                    <img id="artwork" src="{{ $post->getFirstMediaUrl('artwork') }}">
                                @else
                                    <img id="artwork" class="d-none" src="">
                                @endif
                                <div class="post-remove-featured-image @if(! $post->getFirstMediaUrl('artwork')) d-none @endif">Remove featured image</div>
                            </div>
                        ...
                        <div class="form-group row mt-5">
                            <div class="col-sm-12">
                                <label class="switch">
                                    {!! \App\Services\Backend\BackendService::makeCheckbox('is_visible', old('is_visible', $post->visibility)) !!}
                                    <span class="slider round"></span>
                                </label>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <label class="switch">
                                    {!! \App\Services\Backend\BackendService::makeCheckbox('approved', old('approved', $post->approved)) !!}
                                    <span class="slider round"></span>
                                </label>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <label class="switch">
                                    {!! \App\Services\Backend\BackendService::makeCheckbox('allow_main', old('allow_main', $post->allow_main)) !!}
                                    <span class="slider round"></span>
                                </label>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <label class="switch">
                                    {!! \App\Services\Backend\BackendService::makeCheckbox('fixed', old('fixed', $post->fixed)) !!}
                                    <span class="slider round"></span>
                                </label>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <label class="switch">
                                    {!! \App\Services\Backend\BackendService::makeCheckbox('allow_comments', old('allow_comments', $post->allow_comments)) !!}
                                    <span class="slider round"></span>
                                </label>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <label class="switch">
                                    {!! \App\Services\Backend\BackendService::makeCheckbox('disable_index', old('disable_index', $post->disable_index)) !!}
                                    <span class="slider round"></span>
                                </label>
