...
@section('content')
    <script>
        ...
        var revenueSourcesLabelData  = [@foreach($dashboard->plans as $plan) "{{ DB::table('subscriptions')->where('plan_id', $plan->id)->whereIn('subscriptions.status', ['active', 'suspended', 'cancelled'])->count() }}", @endforeach]
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-3">
            <div class="card text-white bg-primary o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="{{ route('backend.songs.index') }}">
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-3">
            <div class="card text-white bg-warning o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="{{ route('backend.artists.index') }}">
                    <span class="float-left">View Details</span>
                    <span class="float-right">
                        <i class="fa fa-angle-right"></i>
                    </span>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-3">
            <div class="card text-white bg-danger o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="{{ route('backend.albums.index')  }}">
                    <span class="float-left">View Details</span>
                    <span class="float-right">
                        <i class="fa fa-angle-right"></i>
                    </span>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-3">
            <div class="card text-white bg-dark o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="{{ route('backend.playlists.index') }}">
                    <span class="float-left">View Details</span>
                    <span class="float-right">
                        <i class="fa fa-angle-right"></i>
                    </span>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-3">
            <div class="card text-white bg-gradient-info o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="{{ route('backend.users.index') }}">
                    <span class="float-left">View Details</span>
                    <span class="float-right">
                        <i class="fa fa-angle-right"></i>
                    </span>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-3">
            <div class="card text-white bg-secondary o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="{{ route('backend.subscriptions.index') }}">
                    <span class="float-left">View Details</span>
                    <span class="float-right">
                        <i class="fa fa-angle-right"></i>
                    </span>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-3">
            <div class="card text-white bg-success o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="{{ route('backend.comments.index') }}">
                    <span class="float-left">View Details</span>
                    <span class="float-right">
                        <i class="fa fa-angle-right"></i>
                    </span>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-3">
            <div class="card text-white bg-gradient-warning o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="{{ route('backend.posts.index') }}">
                    <span class="float-left">View Details</span>
                    <span class="float-right">
                        <i class="fa fa-angle-right"></i>
                    </span>
    ...
    <div id="update-alert" class="alert alert-warning d-none" data-version="{{ env('APP_VERSION') }}">
        ...
        <p>To update your site to the latest version, you need to follow the link: <a href="{{ route('backend.upgrade.index') }}" class="badge badge-pill badge-success">Upgrade Music Engine</a></p>
...
{{--                @if(\App\Models\Group::getValue('admin_users'))--}}
                    <div class="col-xl-6 col-sm-6 mb-3">
                        <a class="quick" href="{{ route('backend.users.index') }}">
                            <div class="media">
...
{{--                @if(\App\Models\Group::getValue('admin_settings'))--}}
                    <div class="col-xl-6 col-sm-6 mb-3">
                        <a class="quick" href="{{ route('backend.settings.index') }}">
                            <div class="media">
...
{{--                @endif--}}
{{--                @if(\App\Models\Group::getValue('admin_pages'))--}}
                    <div class="col-xl-6 col-sm-6 mb-3">
                        <a class="quick" href="{{ route('backend.pages.index') }}">
                            <div class="media">
...
{{--                @if(\App\Models\Group::getValue('admin_users'))--}}
                    <div class="col-xl-6 col-sm-6 mb-3">
                        <a class="quick" href="{{ route('backend.users.edit', auth()->id()) }}">
                            <div class="media">
...
{{--                @if(\App\Models\Group::getValue('admin_roles'))--}}
                    <div class="col-xl-6 col-sm-6 mb-3">
                        <a class="quick" href="{{ route('backend.groups.index') }}">
                            <div class="media">
...
{{--                @endif--}}
{{--                @if(\App\Models\Group::getValue('admin_email'))--}}
                    <div class="col-xl-6 col-sm-6 mb-3">
                        <a class="quick" href="{{ route('backend.email.index') }}">
                            <div class="media">
...
{{--                @endif--}}
{{--                @if(\App\Models\Group::getValue('admin_genres'))--}}
                    <div class="col-xl-6 col-sm-6 mb-3">
                        <a class="quick" href="{{ route('backend.genres.index') }}">
                            <div class="media">
...
{{--                @endif--}}
{{--                @if(\App\Models\Group::getValue('admin_metatags'))--}}
                    <div class="col-xl-6 col-sm-6 mb-3">
                        <a class="quick" href="{{ route('backend.metatags.index') }}">
                            <div class="media">
            ...
            <div class="col-xl-8 col-lg-7">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        <a href="{{ route('backend.reports.index') }}" class="m-0 font-weight-bold text-primary h6 float-right"><i class="fas fa-chart-bar"></i> Get Full Report</a>
                    </div>
                    <div class="card-body">
    ...
    <div class="row">
        @if(\App\Models\Group::getValue('admin_subscriptions'))
            <div class="col-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-shopping-cart"></i> Recent Subscriptions</h6>
                    </div>
                    <div class="card-body">
                        <table class="table table-striped">
                            ...
                            @foreach ($dashboard->subscriptions as $index => $subscription)
                                @if($subscription->user)
                                    <tr>
                                        <td><a href="{{ route('backend.users.edit', ['user' => $subscription->user]) }}">{{ $subscription->user->name }}</a></td>
                                        <td>
                                            @if(\Carbon\Carbon::parse($subscription->trial_end)->gt(\Carbon\Carbon::now()))
                                                <span class="badge badge-info">Trial ends {{ \Carbon\Carbon::parse($subscription->trial_end)->format('F j') }}</span>
                                            @elseif(\Carbon\Carbon::parse($subscription->next_billing_date)->gt(\Carbon\Carbon::now()))
                                                <span class="badge badge-success">Active</span>
                                            @else
                                                <span class="badge badge-danger">in-Active</span>
                                            @endif
                                        <td class="desktop">{{ $subscription->plan->name }}</td>
                                        <td><span class="badge badge-secondary">Auto</span></td>
                                        <td>{{ __('symbol.' . $subscription->currency) }}{{ number_format($subscription->amount) }}</td>
                                        <td class="desktop">{{ $subscription->created_at->diffForHumans() }}</td>
{{--                                        <td class="desktop">{{ timeElapsedString($subscription->created_at) }}</td>--}}
                                    </tr>
                                @endif
                            @endforeach
                        </table>
                    ...
                    <div class="card-body users">
                        @foreach($dashboard->recentUsers as $user)
                            <div class="media border-bottom pb-2 pt-2">
                                <div class="artwork">
                                    <img src="{{ $user->artwork }}" class="media-object rounded-circle">
                                </div>
                                <div class="media-body ml-3">
                                    <h6 class="media-heading"><a href="{{ route('backend.users.edit', $user) }}">{{ $user->name }}</a></h6>
                                    <p class="mb-0">{{ $user->email }}  <span class="text-secondary float-right">{{ $user->created_at->diffForHumans() }}</span></p>
                                </div>
                            </div>
                        @endforeach
                    </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        @foreach($dashboard->recentPosts as $post)
                            <div class="media border-bottom pb-2 pt-2">
                                <div class="media-body">
                                    <h6 class="media-heading"><a href="{{ route('backend.posts.edit', $post) }}">{{ $post->title }}</a></h6>
                                    <p class="mb-0">by <a href="{{ $post->user->permalink_url }}">{{ $post->user->name }}</a> <span class="text-secondary float-right">{{ $post->created_at->diffForHumans() }}</span></p>
                                </div>
                            </div>
                        @endforeach
                    </div>
