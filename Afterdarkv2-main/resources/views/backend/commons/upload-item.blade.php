            ...
            <div class="upload-info-block">
                ...
                <div class="song-info-container">
                    ...
                    <div class="control field multi-artists">
                        ...
                        <select class="form-control multi-selector song-artists-input" data-ajax--url="{{ route('backend.artists.search') }}" name="artistIds[]" multiple="">
                    ...
                    <div class="control field">
                        ...
                        <select class="select2-active" name="genre[]" placeholder="Select genres" multiple autocomplete="off">
                            {!! App\Services\Backend\BackendService::genreSelection(0, 0) !!}}
                        </select>
                    </div>
                    <div class="control field">
                        <label for="copyright">
