@foreach ($episodes as $index => $episode)
    <tr>
        ...
        <td class="desktop">
            <a class="row-button edit" href="{{ route('backend.episodes.edit', $episode) }}" data-toggle="tooltip" data-placement="left" title="Edit this episode"><i class="fas fa-fw fa-edit"></i></a>
            <a class="row-button delete"  href="{{ route('backend.episodes.destroy', $episode) }}" onclick="return confirm('Are you sure want to delete this episode?')" data-toggle="tooltip" data-placement="left" title="Delete this episode"><i class="fas fa-fw fa-trash"></i></a>
        </td>
        <td>
