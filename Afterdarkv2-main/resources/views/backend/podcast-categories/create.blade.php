...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Add new Podcast category</li>
    </ol>
    <div class="row">
        <div class="col-lg-12">
            <form method="POST" action="{{ route('backend.podcast-categories.store') }}" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        {!! makeTagSelector('meta_keywords[]', old('meta_keywords')) !!}
                    </div>
                </div>
                <div class="form-group row">
