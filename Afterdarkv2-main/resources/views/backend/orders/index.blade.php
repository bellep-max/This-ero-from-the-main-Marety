    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-3">
            <div class="card text-white bg-warning o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="https://musicengine.ninacoder.info/admin/artists">
        ...
        <div class="col-lg-12">
            <form method="GET" action="{{ route('backend.orders.index') }}">
                <div class="form-group input-group">
                    <input type="text" class="form-control" name="term" value="{{ request()->input('term') }}" placeholder="Enter customer name">
            ...
            <table class="table table-striped datatables table-hover">
                ...
                @foreach ($orders as $index => $order )
                    @if ($order->user)
                        <tr>
                            <td><a href="{{ route('backend.users.edit', $order->user) }}">{{ $order->user->name }}</a></td>
                            <td>
