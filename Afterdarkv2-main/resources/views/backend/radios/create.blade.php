...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Add new Radio category</li>
    </ol>
    <div class="row">
        <div class="col-lg-12">
            <form method="POST" action="{{ route('backend.radios.store') }}" class="form-horizontal" enctype="multipart/form-data">
                @csrf
