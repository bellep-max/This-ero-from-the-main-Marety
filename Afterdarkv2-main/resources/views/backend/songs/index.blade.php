        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 border-0">
                    <button class="btn btn-link p-0 m-0" type="button" data-toggle="collapse" data-target="#collapseOne"
                            aria-expanded="true" aria-controls="collapseOne">
                        <span class="m-0 font-weight-bold text-primary">Advanced song search</span>
                    </button>
                </div>
                <div class="card-body p-0">
                    <div class="accordion" id="collapseMetaTags">
                        <div id="collapseOne" class="collapse p-4" aria-labelledby="headingOne"
                             data-parent="#collapseMetaTags">
                            <form class="search-form" action="{{ route('backend.songs.index') }}">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Keyword</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="term" class="form-control" placeholder="Song title..."
                                ...
                                <div class="form-group row multi-artists">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control multi-selector-without-sortable"
                                                data-ajax--url="{{ route('backend.artists.search') }}" name="artistIds[]"
                                                multiple="">
                                            @if(request()->input('artistIds') && is_array(request()->input('artistIds')))
                                                @foreach (\App\Models\Artist::whereIn('id', request()->input('artistIds'))->get() as $index => $artist)
                                                    <option value="{{ $artist->id }}" selected="selected"
                                                            data-artwork="{{ $artist->artwork }}"
                                                            data-title="{{ $artist->name }}">{{ $artist->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row multi-artists">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control multi-selector-without-sortable"
                                                data-ajax--url="{{ route('backend.albums.search') }}" name="albumIds[]"
                                                multiple="">
                                            @if(request()->input('albumIds') && is_array(request()->input('albumIds')))
                                                @foreach (\App\Models\Album::whereIn('id', request()->input('albumIds'))->get() as $index => $album)
                                                    <option value="{{ $album->id }}" selected="selected"
                                                            data-artwork="{{ $album->artwork }}"
                                                            data-title="{{ $album->title }}">{{ $album->title }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row multi-artists">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control multi-selector-without-sortable"
                                                data-ajax--url="{{ route('backend.users.search') }}" name="userIds[]"
                                                multiple="">
                                            @if(request()->input('userIds') && is_array(request()->input('userIds')))
                                                @foreach (\App\Models\User::whereIn('id', request()->input('userIds'))->get() as $index => $user)
                                                    <option value="{{ $user->id }}" selected="selected"
                                                            ...
                                                            data-title="{{ $user->name }}">{{ $user->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                        ...
                                        <div class="form-inline">
                                            <div class="input-group mr-3">
                                                ...
                                                <input type="datetime-local"
                                                       class="form-control datetimepicker-with-form" name="created_from"
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="datetime-local"
                                                       class="form-control datetimepicker-with-form"
                                                       name="created_until"
                                                       value="{{ request()->input('created_until') }}"
                                                       autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-inline">
                                            <div class="input-group mb-2 mr-3">
                                                ...
                                                <input type="number" min="0" step="1" class="form-control"
                                                       name="comment_count_from"
                                                       value="{{ request()->input('comment_count_from') }}">
                                            </div>
                                            <div class="input-group mb-2">
                                                ...
                                                <input type="number" min="0" step="1" class="form-control"
                                                       name="comment_count_until"
                                                       value="{{ request()->input('comment_count_until') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-inline">
                                            <div class="input-group mb-2 mr-3">
                                                ...
                                                <input type="number" min="0" step="1" class="form-control"
                                                       name="duration_from"
                                                       value="{{ request()->input('duration_from') }}">
                                            </div>
                                            <div class="input-group mb-2">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">Until</div>
                                                ...
                                                <input type="number" min="0" step="1" class="form-control"
                                                       name="duration_until"
                                                       value="{{ request()->input('duration_until') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-inline">
                                            <select name="format" class="form-control select2-active">
                                                ...
                                                @foreach(\App\Constants\SongFormatConstants::getList() as $format)
                                                    <option value="{{ $format }}"
                                                            @if(request()->input('format') === $format) selected @endif>{{ strtoupper($format) }}</option>
                                                @endforeach
                                            </select>
                                            <div class="input-group ml-3">
                                                ...
                                                <input type="number" min="0" step="1" class="form-control"
                                                       ...
                                                       value="{{ request()->input('results_per_page') ? request()->input('results_per_page') : 50 }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="comment_disabled"
                                                       id="comment_disabled" value="true"
                                                       @if(request()->input('comment_disabled')) checked @endif>
                                                <label class="form-check-label" for="comment_disabled">
                                                    Comment disabled
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="not_approved"
                                                       id="not_approved" value="true"
                                                       @if(request()->input('not_approved')) checked @endif>
                                            ...
                                            <div class="form-check disabled">
                                                <input class="form-check-input" type="checkbox" name="hidden"
                                                       ...
                                                       @if(request()->input('hidden')) checked @endif>
                                ...
                                <a href="{{ route('backend.songs.index') }}" class="btn btn-secondary">Clear</a>
                            </form>
                        </div>
                    </div>
                </div>
            </div>
            <form id="mass-action-form" method="POST" action="{{ route('backend.songs.batch') }}">
                @csrf
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <th class="desktop th-2action">
                            <a data-toggle="tooltip" title="Fans"
                               href="{{ request()->fullUrlWithQuery(["loves" => request()->get('loves') == 'asc' ? 'desc' : 'asc' ]) }}">
                        ...
                        <th class="desktop th-2action">
                            <a data-toggle="tooltip" title="Listens"
                               href="{{ request()->fullUrlWithQuery(["plays" => request()->get('plays') == 'asc' ? 'desc' : 'asc' ]) }}">
                        ...
                        <th class="desktop th-4action">
                            <a data-toggle="tooltip" title="Approved"
                               href="{{ request()->fullUrlWithQuery(["approved" => request()->get('approved') == 'asc' ? 'desc' : 'asc' ]) }}">
