...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <form role="form" action="{{ route('backend.users.store') }}" enctype="multipart/form-data" method="POST">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 col-3">
                        <label class="switch"><input type="checkbox" name="banned"><span class="slider round"></span></label>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control editor" rows="2" name="blockIps">{{ old('blockIps') }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">About me</label>
                    <div class="col-sm-10">
                        <textarea class="form-control editor" rows="2" name="about">{{ old('about') }}</textarea>
                    </div>
                </div>
