        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 border-0">
                    ...
                    <a href="{{ route('backend.users.create') }}" class="btn btn-primary btn-sm float-right">Add new user</a>
                </div>
                <div class="card-body p-0">
                    <div class="accordion" id="collapseMetaTags">
                        <div id="collapseOne" class="collapse p-4" aria-labelledby="headingOne" data-parent="#collapseMetaTags">
                            <form class="search-form" action="{{ route('backend.users.index') }}">
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-inline">
                                            {!! BackendService::makeRolesDropdown('group', request()->input('group')) !!}
                                ...
                                <a href="{{ route('backend.users.index') }}" class="btn btn-secondary">Clear</a>
                            </form>
                        </div>
                    </div>
                </div>
            </div>
            <form id="mass-action-form" method="POST" action="{{ route('backend.users.batch') }}">
                @csrf
