        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 border-0">
                    ...
                    <a href="{{ route('backend.countries.create') }}" class="btn btn-primary btn-sm float-right">Add new country</a>
                </div>
                <div class="card-body p-0">
                    <div class="accordion" id="collapseMetaTags">
                        <div id="collapseOne" class="collapse p-4" aria-labelledby="headingOne" data-parent="#collapseMetaTags">
                            <form class="search-form" action="{{ route('backend.countries.index') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        {!! BackendService::makeRegionDropdown("region", 'select2-active', request()->input('region')) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Government Form</label>
                                    <div class="col-sm-10">
                                        {!! BackendService::makeDropdown($governmentForms, "government_form", request()->input('government_form'), false) !!}
                                    </div>
                                </div>
                                ...
                                <a href="{{ route('backend.countries.index') }}" class="btn btn-danger"><i class="fas fa-eraser"></i> Clear Filter</a>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <form id="mass-action-form" method="POST" action="">
                <table class="table table-striped">
                    ...
                    @foreach ($countries as $index => $country)
                        <tr>
                            <td width="100px"><img class="media-object img-160-90" src="{{ $country->artwork }} alt="{{ $country->name }}"></td>
                            <td><a href="{{ route('backend.countries.edit', $country) }}">{{ $country->name }}</a></td>
                            ...
                            <td>
                                <a href="{{ route('backend.countries.edit', $country) }}" class="row-button edit"><i class="fas fa-fw fa-edit"></i></a>
                                <a href="{{ route('backend.countries.destroy', $country) }}" onclick="return confirm('Are you sure want to delete this country?')" class="row-button delete"><i class="fas fa-fw fa-trash"></i></a>
                            </td>
                            <td>
                                <label class="engine-checkbox">
                                    <input name="ids[]" class="multi-check-box" type="checkbox" value="{{ $country->code }}">
                                    <span class="checkmark"></span>
                                </label>
                            </td>
                    @endforeach
                        ...
                        <div class="form-inline float-sm-right">
                            <div class="form-group mb-2">
                                <select name="action" class="form-control mr-2">
                                    ...
                                    <option value="add_radio_category">Make Hidden</option>
                                    <option value="change_radio_category">Make Visible</option>
                                    <option value="comments">Pin Country</option>
                                    <option value="not_comments">Unpin Country</option>
