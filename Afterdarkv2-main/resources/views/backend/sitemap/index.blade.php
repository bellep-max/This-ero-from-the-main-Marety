                    ...
                    @if (isset($filemtime))
                        <div class="card mt-4 py-3 border-left-info">
                            <div class="card-body card-small">
                                <p class="mb-0">Index file for Google Sitemap was created at <strong class="text-success">{{ $filemtime }}</strong> (server time) and is available at: <a href="{{ route('home.index') }}/sitemap.xml" target="_blank">{{ route('home.index') }}/sitemap.xml</a></p>
                            </div>
                        </div>
                    @endif
                    <div class="row">
                        <div class="col-12">
                            <form method="POST" action="{{ route('backend.sitemap.store') }}">
                                @csrf
                                <div class="form-group row border-bottom mb-0 pt-3 pb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="number" step="1" class="form-control" name="post_num" value="1000" required="">
                                    </div>
                                </div>
                                <div class="form-group row border-bottom mb-0 pt-3 pb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="number" step="1" class="form-control" name="song_num" value="1000" required="">
                                    </div>
                                </div>
                                <div class="form-group row border-bottom mb-0 pt-3 pb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="number" step="0.1" min="0.1" max="1" class="form-control" name="static_priority" value="0.5" required="">
                                    </div>
                                </div>
                                <div class="form-group row border-bottom mb-0 pt-3 pb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="number" step="0.1" min="0.1" max="1" class="form-control" name="song_priority" value="0.5" required="">
                                    </div>
                                </div>
                                <div class="form-group row border-bottom mb-0 pt-3 pb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="number" step="0.1" min="0.1" max="1" class="form-control" name="blog_priority" value="0.5" required="">
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-primary mt-4">Create/update the site map file </button>
                            </form>
                        </div>
                    </div>
                </div>
