        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 border-0">
                    ...
                    <a href="{{ route('backend.stations.create') }}" class="btn btn-primary btn-sm float-right">Add new
                        station</a>
                </div>
                <div class="card-body p-0">
                    <div class="accordion" id="collapseMetaTags">
                        <div id="collapseOne" class="collapse p-4" aria-labelledby="headingOne"
                            ...
                            <form class="search-form" action="{{ route('backend.stations.index') }}">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row">
                                            ...
                                            <div class="col-6 input-group mb-2">
                                                {!! BackendService::makeDropdown(\App\Constants\SearchConstants::getFullList(\App\Constants\TypeConstants::STATION), 'location',  request()->input('location') ?: 0) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select multiple="" class="form-control select2-active" name="category[]">
                                            {!! BackendService::radioCategorySelection(request()->input('category')) !!}
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-inline">
                                            <div class="filter-country">
                                                {!! BackendService::makeCountryDropdown('country', 'form-control select2-active filter-country-select', request()->input('country')) !!}
                                            </div>
                                            <div class="ml-3 @if(! request()->input('country')) d-none @endif filter-city filter-city-select">
                                                @if(request()->input('country'))
                                                    {!! BackendService::makeCityDropDown(request()->input('country'), 'city', 'form-control select2-active', request()->input('city')) !!}
                                                @endif
                                            </div>
                                        ...
                                        <div class="form-inline">
                                            <div class="filter-city-select">
                                                @if(request()->input('country') || request()->input('language'))
                                                    {!! BackendService::makeCountryLanguageDropdown(request()->input('country'), 'language', 'form-control select2-active', request()->input('language')) !!}
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <a href="{{ route('backend.stations.index') }}" class="btn btn-danger"><i
            ...
            <form id="mass-action-form" method="POST" action="{{ route('backend.songs.batch') }}">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <th>Description</th>
                        <th width="100px" data-toggle="tooltip"
                            title="Times player unable to play the station. You should check stream link if the number of failing keep increasing.">
                            Failed
                        </th>
