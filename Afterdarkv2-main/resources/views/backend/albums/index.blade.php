        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 border-0">
                    ...
                    <a href="{{ route('backend.albums.create') }}" class="btn btn-primary btn-sm float-right">Add new album</a>
                </div>
                <div class="card-body p-0">
                    <div class="accordion" id="collapseMetaTags">
                        <div id="collapseOne" class="collapse p-4" aria-labelledby="headingOne" data-parent="#collapseMetaTags">
                            <form class="search-form" action="{{ route('backend.albums.index') }}">
                                ...
                                <div class="form-group row multi-artists">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control multi-selector-without-sortable" data-ajax--url="{{ route('backend.artists.search') }}" name="artistIds[]" multiple="">
            ...
            <form id="mass-action-form" method="POST" action="{{ route('backend.albums.batch') }}">
                @csrf
