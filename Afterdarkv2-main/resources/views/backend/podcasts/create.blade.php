...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Add new podcast</li>
    </ol>
    <div class="row">
        <div class="col-lg-12">
            <form method="POST" action="{{ route('backend.podcasts.store') }}" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-sm-9">
                        <div class="form-inline">
                            <div class="filter-country">
                                {!! \App\Helpers\Helper::makeCountryDropdown('country_id', 'form-control select2-active filter-country-select', old('country_id')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-group row filter-language d-none">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" type="url" name="rss_feed_url" value="{{ old('rss_feed_url') }}">
                    </div>
                </div>
