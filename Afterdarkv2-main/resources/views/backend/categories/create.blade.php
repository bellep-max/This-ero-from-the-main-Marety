            ...
            <form role="form" method="POST" action="{{ route('backend.categories.store') }}"
                ...
                <div class="form-group row border-bottom mb-0 pt-3 pb-3">
                    <label class="col-sm-3">Name
                        <p class="small">The name is how it appears on your site.</p>
                    </label>
                    <div class="col-sm-9">
                ...
                <div class="form-group row border-bottom mb-0 pt-3 pb-3">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control" rows="2" name="meta_description"
                                  placeholder="Option">{{ old('meta_description') }}</textarea>
                    </div>
                </div>
                <div class="form-group row border-bottom mb-0 pt-3 pb-3">
                ...
                <div class="form-group row border-bottom mb-0 pt-3 pb-3">
                    ...
                    <div class="col-sm-9">
                        {!! BackendService::makeDropdown( \App\Constants\NewsSortConstants::getFullList(), "news_sort", old('news_sort') ) !!}
                    </div>
                </div>
                <div class="form-group row border-bottom mb-0 pt-3 pb-3">
                    <label class="col-sm-3">Show news published in the sub-categories</label>
                    <div class="col-sm-9">
                        {!! BackendService::makeDropdown( \App\Constants\NewsSubcategorySortConstants::getFullList(), "show_sub", old('show_sub') ) !!}
                    </div>
                </div>
                <div class="form-group row border-bottom mb-0 pt-3 pb-3">
                    ...
                    <div class="col-sm-9">
                        <label class="switch">
                            {!! BackendService::makeCheckbox('disable_main', old('disable_main')) !!}
                ...
                <div class="form-group row border-bottom mb-0 pt-3 pb-3">
                    ...
                    <div class="col-sm-9">
                        <label class="switch">
                            {!! BackendService::makeCheckbox('disable_comments', old('disable_comments')) !!}
                            <span class="slider round"></span>
                        </label>
                    </div>
                </div>
                <div class="form-group row border-bottom mb-0 pt-3 pb-3">
                    ...
                    <div class="col-sm-9">
                        <label class="switch">
                            {!! BackendService::makeCheckbox('disable_search', old('disable_search')) !!}
                            <span class="slider round"></span>
                        </label>
                    </div>
                </div>
                        ...
                        <div class="input-group col-xs-12">
                            ...
                            <span class="input-group-btn">
                                <button class="browse btn btn-primary input-lg" type="button">
                                    <i class="fas fa-fw fa-file"></i> Browse
                                </button>
                            </span>
                        </div>
                    </div>
