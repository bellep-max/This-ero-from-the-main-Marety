        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col col-xl-9">
                    <div class="container d-flex flex-column w-100 gap-4 bg-light rounded-5 p-3 p-lg-5 overflow-hidden">
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row gy-3">
                            <div class="col-12">
                                @if(count($playlist->collaborators))
                                    <div class="row mt-3 tread-container overflow-y-auto">
                                        @foreach($playlist->collaborators as $collaborator)
                                            @include('frontend.components.cards.playlist-subscriber-item', ['subscriber' => $collaborator, 'controls' => true])
                                        @endforeach
                                    </div>
                                @else
                                    <div class="d-flex flex-row flex-wrap justify-content-center align-items-center gap-2 row-gap-2 text-center">
                                        @if(! auth()->check() || auth()->check() && auth()->user()->username != $playlist->username)
                                            <h3 class="font-default" data-translate-text="PLAYLIST_EMPTY_COLLABORATORS">{{ __('web.PLAYLIST_EMPTY_COLLABORATORS') }}</h3>
                                        @else
                                            <h3 class="font-default" data-tranlsate-text="PLAYLIST_EMPTY_COLLABORATORS_OWNER">{{ __('web.PLAYLIST_EMPTY_COLLABORATORS_OWNER') }}</h3>
                                            <p class="font-default" data-tranlsate-text="PLAYLIST_EMPTY_COLLABORATORS_DESC_OWNER">{{ __('web.PLAYLIST_EMPTY_COLLABORATORS_DESC_OWNER') }}</p>
                                        @endif
                                    </div>
                                @endif
                            </div>
