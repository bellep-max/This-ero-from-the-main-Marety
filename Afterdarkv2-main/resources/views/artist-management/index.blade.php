        ...
        <div class="page-header artist-management main">
            ...
            <div class="inner">
                ...
                <div class="actions-primary">
                    ...
                    <a class="btn" data-action="withdraw" data-min="{{ \App\Models\Group::getUserValue('monetization_paypal_min_withdraw', auth()->id()) }}" data-max="{{ number_format(auth()->user()->balance, 2) }}">
                ...
                <div class="col-xl-6 col-lg-6 col-sm-6 mb-3">
                    <div class="card text-white bg-secondary o-hidden h-100">
                        ...
                        <div class="card-footer text-white clearfix small z-1">
                            <span class="float-left">Song's Streaming Revenue</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-sm-6 mb-3">
                    <div class="card text-white bg-danger o-hidden h-100">
                        ...
                        <div class="card-footer text-white clearfix small z-1">
                            <span class="float-left">Podcast's Streaming Revenue</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 col-6 mb-4">
                    <div class="card o-hidden h-100 shadow artist">
                        <div class="card-body">
                            ...
                            <p class="d-block text-center mt-2 mb-2 counter">{{ thousandsCurrencyFormat(\App\Models\Order::where('user_id', auth()->id())->count()) }}</p>
