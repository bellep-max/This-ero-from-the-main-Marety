                ...
                <div class="content row">
                    <div class="fields col-lg-6 col-12">
                        <div class="control">
                            ...
                            <textarea type="text" class="span6" name="bio" maxlength="180"></textarea>
                        </div>
                    </div>
                    <div class="description col-lg-6 col-12 desktop">
                    ...
                    <div class="fields col-lg-6 col-12">
                        <div class="control">
                            <div class="d-flex">
                                ...
                                <label class="lbl" for="payment_paypal">Paypal - Minimum {{ \App\Models\Group::getUserValue('monetization_paypal_min_withdraw', auth()->id()) }} {{ config('settings.currency', 'USD') }}.</label>
                            </div>
                    ...
                    <div class="fields col-lg-6 col-12">
                        <div class="control">
                            <div class="d-flex">
                                ...
                                <label class="lbl" for="payment_bank">Bank Transfer - Minimum {{ \App\Models\Group::getUserValue('monetization_bank_min_withdraw', auth()->id()) }} {{ config('settings.currency', 'USD') }}.</label>
                            </div>
