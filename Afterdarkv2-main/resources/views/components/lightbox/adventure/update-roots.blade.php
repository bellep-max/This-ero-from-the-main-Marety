<div class="lightbox lightbox-adventure-update-roots limited-height-popup hide">
    ...
    <div class="lightbox-content">
        <div class="lightbox-content-block d-flex flex-column justify-content-start align-items-center gap-3 w-100">
            ...
            <div id="adventure-update-children" class="d-flex flex-column justify-content-start align-items-center w-100 gap-3"></div>
            <div class="d-flex flex-row justify-content-between align-items-center mt-3 w-100">
                <a id="adventure-update-back-to-parent-popup" href="" class="btn-default btn-outline back">
                ...
                <div id="to-adventure-update-diagram" href="" class="btn-default btn-pink next active">
                    Next
                    <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                        <!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
