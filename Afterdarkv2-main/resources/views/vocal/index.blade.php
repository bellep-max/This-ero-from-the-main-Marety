@extends('index')
@section('pagination')
    @include('commons.song', ['songs' => $songs, 'element' => 'genre'])
@stop
@section('content')
    {!! Advert::get('header') !!}
    <div class="container">
