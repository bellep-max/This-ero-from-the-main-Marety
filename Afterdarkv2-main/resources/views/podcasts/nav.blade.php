<div id="page-nav">
    <div class="outer">
        <ul>
            <li><a href="{{ $album->permalink_url }}" class="page-nav-link @if(Route::currentRouteName() == 'frontend.album.show') active @endif" data-translate-text="OVERVIEW">{{ __('web.OVERVIEW') }}<div class="arrow"></div></a></li>
