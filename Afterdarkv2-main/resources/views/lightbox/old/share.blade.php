<form id="share-lightbox">
    <div class="lightbox-header lightbox-nav-container">
        <ul class="lightbox-nav">
            <li id="share-embed" class="share-svc active" data-share-svc="embed" data-translate-text="LB_SITE_PLAYER">{{ __('web.LB_SHARE_EMBED') }}</li>
            <li id="share-facebook" class="share-svc" data-share-svc="facebook">Facebook</li>
            <li id="share-twitter" class="share-svc" data-share-svc="twitter">Twitter</li>
            <li id="share-more" class="share-svc" data-share-svc="more" data-translate-text="MORE">{{ __('web.MORE') }}</li>
        </ul>
