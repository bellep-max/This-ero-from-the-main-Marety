<div id="page-nav">
    <div class="outer">
        <ul>
            <li><a class="page-nav-link @if(Route::currentRouteName() == 'frontend.settings.index') active @endif" href="{{ route('frontend.settings.index') }}" data-translate-text="SETTINGS_NAV_PROFILE">{{ __('web.SETTINGS_NAV_PROFILE') }}</a></li>
            @if(! \App\Models\Group::getValue('admin_access'))
