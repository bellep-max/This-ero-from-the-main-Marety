    ...
    @if($element == "carousel")
        <div class="module module-cell playlist block swiper-slide draggable" data-toggle="contextmenu" data-trigger="right" data-type="playlist" data-id="{{ $playlist->id }}">
            <div class="img-container" data-type="playlist" data-id="{{ $playlist->id }}">
                <img class="img" src="{{ $playlist->artwork }}">
            ...
            <div class="module-inner">
                ...
                @if(isset($playlist->user))
                    <span class="byline">by <a href="{{ route('frontend.user.show', ['user' => $playlist->user->username]) }}" class="playlist-link" title="{{ $playlist->user->name }}">{{ $playlist->user->name }}</a></span>
                @endif
            </div>
        </div>
            ...
            <div class="metadata playlist">
                ...
                @if(isset($playlist->user))
                    <div class="meta-inner">
                        <span data-translate-text="BY">by <a href="{{ route('frontend.user.show', ['user' => $playlist->user->name]) }}" class="meta-text">{{ $playlist->user->name }}</a></span>
                    </div>
                @endif
            </div>
    ...
    @elseif($element == "activity")
        ...
        <div class="feed-item">
            ...
            <div class="inner">
                ...
                @if(isset($playlist->user))
                    <a href="{{ route('frontend.user.show', ['user' => $playlist->user->username]) }}" class="item-subtitle artist-link">{{ $playlist->user->name }}</a>
                @endif
