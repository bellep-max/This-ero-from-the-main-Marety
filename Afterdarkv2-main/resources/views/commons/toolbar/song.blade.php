<div class="bg-default d-flex flex-row justify-content-between align-items-center rounded-4" id="grid-toolbar-container">
    <div class="profile_page__content__filters__toolbar-inner">
        ...
        @if(isset($trending))
            <div class="d-flex flex-row justify-content-start align-items-center actions desktop">
            ...
            <div class="d-flex flex-row justify-content-start align-items-center actions desktop">
                ...
                @if(isset($profile))
                    <div class="btn-group first">
                        <a href="{{ route('frontend.user.collection', $profile->username) }}" class="btn all-music @if(Route::currentRouteName() == 'frontend.user.collection') active @endif">
                            <span data-translate-text="ALL_MUSIC">{{ __('web.ALL_MUSIC') }}</span>
                        </a>
                        <a href="{{ route('frontend.user.favorites', $profile->username) }}" class="btn favorites @if(Route::currentRouteName() == 'frontend.user.favorites') active @endif">
