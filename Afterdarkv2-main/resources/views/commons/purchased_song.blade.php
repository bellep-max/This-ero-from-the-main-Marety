...
<div class="flat-song-list">
    <div class="flat-song-list-play-container">
        <a title="Play" class="flat-song-list-play-button play-object" data-type="song" data-id="{{ $song->id }}">
    ...
    @endif
    <button class="basic-tooltip text-secondary flat-song-list-button btn-file-format" tooltip="{{ __('web.DOWNLOAD_ALL') }}">
        <a href="{{ route('frontend.purchased.download.song', ['id' => $song->id, 'format' => 'all']) }}" target="_blank">
            <span>ALL</span>
        </a>
    </button>
</div>
