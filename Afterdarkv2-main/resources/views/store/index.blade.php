        ...
        @foreach($songs as $song)
            ...
            <div class="flat-song-list">
                <div class="flat-song-list-play-container">
                    <a title="Play" class="flat-song-list-play-button play-object" data-type="song" data-id="{{ $song->id }}" style="background-image: url('{{ $song->artwork }}')">
                ...
                <div class="flat-song-list-subtitle text-secondary">${{ $song->price }}</div>
