...
return [
    ...
    'ONLY_FOR_PATRONS' => 'Only for Patrons',
    'MEMBER' => 'Member',
    'SUBMIT' => 'Submit',
    ...
    'SIGN_IN' => 'Sign In',
    'SIGN_OUT' => 'Sign Out',
    'SIGN_IN_FACEBOOK' => 'With Facebook',
    'SIGN_IN_TWITTER' => 'With Twitter',
    'SIGN_IN_GOOGLE' => 'With Google',
    ...
    'WATCH_ADVENTURE' => 'Watch Adventure',
    ...
    'SETTINGS_NAME_TIP' => "This will be displayed on your <a href='/:userLink'>profile</a>, so be sure to use a name people will be able to recognize and search for.",
    ...
    'POPUP_DELETE_PROFILE_DELETE_WARNING' => 'Are you sure you want to delete your account? <br><br>Deleting your account will permanently remove all your personal information and data associated with it. This action cannot be undone. Please be aware that you will lose access to all features and services provided by our platform.',
    'POPUP_AGE_WARNING_TITLE' => "Are you <span class='color-pink'>over 18 years</span> old?",
    'POPUP_AGE_WARNING_TEXT' => 'The site contains information that is not recommended for persons under the age of majority.',
    'POPUP_PODCAST_METADATA_CREATE' => 'Create Podcast',
    'HAS_18' => 'I am over 18',
    'NOT_18' => 'I am under 18',
    'POPUP_DELETE_PROFILE' => 'Delete Account',
    'LINKTREE' => 'Linktree',
    'LINKTREE_META_TEXT' => 'some linktree text',
    'LINKTREE_INPUT_PLACEHOLDER' => 'Paste Linktree link here',
    'LINKTREE_VISIT' => 'Visit Linktree',
    ...
    'POPUP_EDIT_SONG_DENIED' => "You don't have permission to edit this song. The song has reached the limited time it can be edited.",
    'POPUP_DELETE_SONG_DENIED' => "You don't have permission to delete this song. The song has reached the limited time it can be edited.",
    'POPUP_EDIT_ALBUM_DENIED' => "You don't have permission to edit this album. The album has reached the limited time it can be edited.",
    'POPUP_DELETE_ALBUM_DENIED' => "You don't have permission to delete this album. The album has reached the limited time it can be deleted.",
    'POPUP_DELETED_SONG' => 'Your song has been successfully deleted.',
    'POPUP_DELETED_ALBUM' => 'Your album has been successfully deleted.',
    'POPUP_DELETE_PODCAST_DENIED' => "You don't have permission to delete this podcast. The podcast has reached the limited time it can be deleted.",
    ...
    'FORM_FACEBOOK_LINK' => 'Facebook profile link:',
    ...
    'SEND' => 'Send',
    'FORM_TOS_2' => 'By signing up you agree to the Terms of Service',
    'FORM_SIGNUP' => 'Sign up',
    ...
    'SCRIPT' => 'Script / Writer Link',
    'URL_OF_YOUR_TRACK' => 'Url Of Your Track',
    'SELL_THIS_SONG_TIP' => 'Name your price, in USD',
    'FORM_RSS_FEED' => 'RSS feed URL',
    ...
    'LB_UPLOAD_NOTICE' => 'Uploading music to makes your songs available for streaming from anywhere in the world. Please refer to our <a class="text-primary" href="" target="_blank">Terms of Service</a> if you have any questions, and only upload content that does not infringe upon the rights of others.',
    ...
    'SONG_BYLINE' => 'Song by :artist on :album',
