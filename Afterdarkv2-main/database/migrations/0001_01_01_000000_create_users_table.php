    ...
    public function up(): void
    {
        if (!Schema::hasTable('users')) {
            Schema::create('users', function (Blueprint $table) {
                ...
                $table->rememberToken();
                $table->unsignedBigInteger('artist_id')->default(0)->index();
                ...
                $table->integer('crossfade_amount')->default(5);
                ...
                $table->decimal('balance', 10)->nullable()->default(0.000000);
                $table->text('payment_bank')->nullable();
                $table->string('payment_paypal')->nullable();
                $table->string('payment_method', 50)->nullable();
                $table->string('linktree_link')->nullable();
                $table->unsignedBigInteger('group_id')->default(RoleConstants::GUEST);
