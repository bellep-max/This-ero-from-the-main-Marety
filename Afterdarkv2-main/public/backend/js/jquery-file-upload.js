                    ...
                    data.context.each(function (index) {
                        ...
                        that._transition($(this)).done(
                            ...
                            function () {
                                ...
                                $(this).find('.img-fluid img').attr('src', song.artwork_url);
                                ...
                                $(this).find('.edit-song-artwork-input').change(function(){
                                    ...
                                    if (input.files && input.files[0]&& (ext === "gif" || ext === "png" || ext === "jpeg" || ext === "jpg")) {
                                        ...
                                        reader.onload = function (e) {
                                            $(this).find('.img-fluid img').attr('src', e.target.result);
                                        };
                                ...
                                $(".multi-selector").select2({
                                    ...
                                    templateSelection: function (repo) {
                                        ...
                                        const markup = `<div class="select2-result-repository clearfix">
