...
class UserSubscriptionController extends ApiController
{
    ...
    public function checkout(User $user, Request $request): JsonResponse
    {
    ...
    public function paymentSuccess(User $user, Request $request): JsonResponse
    {
        ...
        return $this->success(null, 'Subscription created successfully');
    }

    public function cancel(User $user, Request $request): JsonResponse
    {
    ...
    public function suspend(User $user, Request $request): JsonResponse
    {
        ...
        return $this->success(null, 'Subscription suspended successfully');
    }
    ...
    public function activate(User $user, Request $request): JsonResponse
    {
        ...
        return $this->success(null, 'Subscription activated successfully');
    }
}
