...
{
    public function artisan(): View|Application|Factory
    {
    ...
    public function runArtisan(): string
    {
    ...
    public function runDatabase(): string
    {
        $query = Request::get('q');
    ...
    protected function getDumpedHtml($var): string
    {
        ob_start();
    ...
    protected function table(array $headers, $rows, $style = 'default'): string
    {
        $output = new StringOutput;
    ...
    protected function dispatchQuery($connection, $query): string
    {
        [$type, $connection] = explode(':', $connection);
    ...
    protected function execMongodbQuery($config, $query): string
    {
    ...
    protected function execRedisCommand($connection, $command): string
    {
    ...
    protected function organizedCommands(): array
    {
