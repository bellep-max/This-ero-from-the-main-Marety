...
class PodcastCategoryUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            'name' => [
                'required',
                'string',
                'unique:podcast_categories,name,' . $this->category->id,
            ],
            'alt_name' => [
                'nullable',
                'string',
                'unique:podcast_categories,alt_name,' . $this->category->id,
            ],
            'description' => [
                'nullable',
                'string',
